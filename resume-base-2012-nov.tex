...
\cvitem{Programming Languages} { Java, JSP, Ruby, PHP, C\#, C++, Python, Bash, JavaScript, XML }
\cvitem{Frameworks} { Spring, Hibernate, Rails }
\cvitem{Server Platforms} { Linux (RedHat, CentOS, Ubuntu), JBoss 5, JBoss AS 7, Jenkins }
\cvitem{Mobile Platforms} { SymbianOS }
\cvitem{Operations} { Continuous Deployment, Jenkins, Capistrano }
\cvitem{Development Methodologies} { Scrum, NPI, CDM }

\section{Experience}

\cventry{July 2011 -- Present}{Software Engineer 4}{Juniper Networks}{Columbus, OH}{}{}
