...
\cvitem{Programming Languages} { Ruby/Rails, Python, Clojure, Java, C\#, C++, Bash, JavaScript, PHP, SQL }
\cvitem{Server Platforms} { Linux (RedHat, CentOS, Ubuntu), JBoss 5-7,
IBM Pure Application Systems}
\cvitem{DevOps \& Automation} { Ansible, Puppet, Jenkins/Hudson, Maven, ANT, Git }
