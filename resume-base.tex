...
\cvitem{Programming Languages} { Ruby, Python, Java, Clojure, C\#, C++, Bash, JavaScript, PHP }
...
\begin{itemize}
    ...
    \item[$\bullet$] Migrated legacy SMobile tools including defect tracking, source
        control, and release management tools into their Juniper equivalents.

    \item[$\bullet$] Trained Juniper team members on the use and architecture of SMobile technology.

    \item[$\bullet$] Maintained release cadence in order to continue delivery of SMobile
        technology during integration.

    \item[$\bullet$] Wrote functional specifications for proposed new functionality.
